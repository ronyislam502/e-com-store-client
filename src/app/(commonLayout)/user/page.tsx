...
const User = () => {
  ...
  return (
    <div className="max-w-xl mx-auto bg-slate-100 p-5 shadow-lg rounded-md mt-5 text-black">
      ...
      <div className="flex justify-between space-y-4">
        <div className="">
          ...
          <p className="text-md font-semibold">{formatDate(user?.updateAt)}</p>
        </div>
        <div>
          <h3 className="text-xl font-bold">Since Member</h3>
          <p className="text-md font-semibold">{formatDate(user?.createdAt)}</p>
        </div>
      </div>
